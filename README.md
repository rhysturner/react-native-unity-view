...
This is a fork of [https://github.com/asmadsen/react-native-unity-view](https://github.com/asmadsen/react-native-unity-view) which is a fork of [https://github.com/f111fei/react-native-unity-view](https://github.com/f111fei/react-native-unity-view)
to make it work with React Native >= 0.60 and Unity 20.X

**This project may or may not be updated depending on the further use of it at my workplace, however feel free to fork it** 

## Install

`yarn add @rhysturner/react-native-unity-view`
